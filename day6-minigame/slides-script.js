// Day6 Pre-learning Slides JavaScript
...
function startMinigame() {
    ...
    localStorage.setItem('day6-slides-completed', 'true');
...
function trackSlideProgress() {
    ...
    localStorage.setItem('slide-progress-day6', JSON.stringify(progress));
}

// Load previous progress if available
function loadSlideProgress() {
    const savedProgress = localStorage.getItem('slide-progress-day6');
    if (savedProgress) {
        try {
